...
export function DashboardPage() {
  ...
  const integrationCards = [
    { label: "Clientes", value: stats.totalCustomers, icon: Users, color: "text-blue-500", bg: "bg-blue-500/10", link: "/clientes" },
    { label: "Vendas", value: stats.totalSales, subtitle: formatCompact(stats.totalSalesValue), icon: ShoppingCart, color: "text-emerald-500", bg: "bg-emerald-500/10", link: "/vendas" },
    { label: "Tickets Abertos", value: stats.openTickets, icon: Headphones, color: "text-orange-500", bg: "bg-orange-500/10", link: "/pos-venda" },
    { label: "Prospects Quentes", value: stats.hotProspects, subtitle: `de ${stats.totalProspects} total`, icon: Target, color: "text-purple-500", bg: "bg-purple-500/10", link: "/prospeccao" },
  ];
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <Card className="border-none shadow-sm cursor-pointer hover:shadow-md" onClick={() => navigate("/estoque")}>
          <CardContent className="p-5">
              ...
              <Table>
                ...
                <TableBody>
                  {(stats.recentSales || []).map((s) => (
                    <TableRow key={s.id} className="cursor-pointer" onClick={() => navigate("/vendas")}>
