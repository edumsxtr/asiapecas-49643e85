    ...
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between gap-4">
          <Link to="/cotacao" className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <p className="font-semibold text-sm font-display leading-tight">Ásia Peças &amp; Máquinas</p>
      ...
      <footer className="bg-secondary text-secondary-foreground mt-12">
        ...
        <div className="border-t border-secondary-foreground/10">
          <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 text-center text-xs text-secondary-foreground/50">
